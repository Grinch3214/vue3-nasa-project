    ...
    <div class="container">
      ...
      <div class="nasa__inner" v-if="isItemExist">
        <a class="nasa__image" :href="bigImg" target="_blank">
          <img
            :src="nasaStore.itemID[0].links[0].href"
            :alt="nasaStore.itemID[0].data[0].title"
          />
        </a>
        <div class="nasa__box">
          <h1 class="nasa__box-title">
            {{ nasaStore.itemID[0].data[0].title }}
          </h1>
          <div class="nasa__id">
            Nasa id: <span>{{ nasaStore.itemID[0].data[0].nasa_id }}</span>
          </div>
          <p
            class="nasa__box-description link-nasa"
            v-html="nasaStore.itemID[0].data[0].description"
          ></p>
          <p class="nasa__created">
            Date Created:
            <span>{{
              fixDateString(nasaStore.itemID[0].data[0].date_created)
            }}</span>
          </p>
          <div class="nasa__keywords">
            ...
            <ul>
              <li
                v-for="(item, index) of nasaStore.itemID[0].data[0].keywords"
                :key="index"
              >
                {{ item }}
              </li>
